 ...
 * 
 * @return array Array with all measuring points and the corresponding measured values.
 */
function fetchMeasurements() {
  ...
  $params['typeName'] = 'opendata:odlinfo_odl_1h_latest';
   ...
   */
  $response = json_decode(curl_exec($ch), TRUE)['features'];
